...
for iter_num in range(1, 501):
    ...
    for i in range(10):
        ...
        sub_record.append(accuracy_score(test_y, pred_y))
        
    record.append(np.average(np.array(sub_record)))


# In[101]:


# ==================== finding good features with Tf-based feature selection ========================
...
plt.savefig( 'Random-Forest-feature-selection.png' )
